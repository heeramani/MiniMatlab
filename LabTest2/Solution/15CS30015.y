%{
    #include "15CS30015_translator.h"
                                ...
                                unary_expression assignment_operator assignment_expression {
                                															if($2 == 0){
                                                                                                ...
                                                                                                glob_quad.emit(Q_ASSIGN,$3.loc->name,$$.loc->name);
																											...
																											typecheck (&$$, &$3);
																											$$.loc = curr_st->gentemp($$.type);
																											$$.type = $$.loc->tp_n;
																											glob_quad.emit(Q_MULT,$$.loc->name,$3.loc->name,$$.loc->name);
																											...
																											$$.loc = curr_st->gentemp($$.type);
																											$$.type = $$.loc->tp_n;
																											glob_quad.emit(Q_DIVIDE,$$.loc->name,$3.loc->name,$$.loc->name);
																											...
																											$$.loc = curr_st->gentemp($$.type);
																											$$.type = $$.loc->tp_n;
																											glob_quad.emit(Q_MODULO ,$$.loc->name,$3.loc->name,$$.loc->name);
																											...
																											$$.loc = curr_st->gentemp($$.type);
																											$$.type = $$.loc->tp_n;
																											glob_quad.emit(Q_PLUS,$$.loc->name,$3.loc->name,$$.loc->name);
																											...
																											$$.loc = curr_st->gentemp($$.type);
																											$$.type = $$.loc->tp_n;
																											glob_quad.emit(Q_MINUS,$$.loc->name,$3.loc->name,$$.loc->name);
																											...
																											$$.loc = curr_st->gentemp($$.type);
																											$$.type = $$.loc->tp_n;
																											glob_quad.emit(Q_LEFT_OP,$$.loc->name,$3.loc->name,$$.loc->name);
																											...
																											$$.loc = curr_st->gentemp($$.type);
																											$$.type = $$.loc->tp_n;
																											glob_quad.emit(Q_AND,$$.loc->name,$3.loc->name,$$.loc->name);
                                                                                            
                                                                                            
                                                                                            }
																							else{
																									string s11 = "Error assignment opr";
																									printf ("Error assignment opr %s\n", $$);
																									return -1;
																								}                                                                            
...
matrix_content	: matrix_row {
				...
				| matrix_row ';' matrix_content {
					
				}
				;
				
matrix_row		: primary_expression {
					
				}
				|  primary_expression ',' matrix_row {
				}
				;                                                                                            
...
declaration:                    declaration_specifiers init_declarator_list_opt ';' {
																					...
																					MATRIX IDENTIFIER '[' INTEGER_CONSTANT ']' '[' INTEGER_CONSTANT ']' '=' matrix_format ';' {
...
selection_statement:            IF '(' expression N ')' M statement N ELSE M statement {
                                ...
                                SWITCH '(' expression N ')' M statement {
                                                                       
                                                                    };
                                  /*                                  
                                IF '(' expression N ')' GOTO M statement ELSE GOTO M statement{
                                                                                              $7 = merge($7,$8);
                                                                                            $11 = merge($11,makelist(next_instr));
                                                                                            glob_quad.emit(Q_GOTO,"-1");
                                                                                            backpatch($4,next_instr);
